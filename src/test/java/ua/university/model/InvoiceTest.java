...
public class InvoiceTest {
    ...
    class ToStringTests{
        ...
        void testToString() {
            assertEquals("Invoice {reservation: Reservation {guest: Guest {firstName: O, lastName: D, email: od@gmail.com, checkInDate: 01-11-2025}, " +
                    "\nroom: Room {room number: 121, type: presidential, capacity: 4, price: 125.0, room status: occupied}, \nstartDate: 29-10-2025, endDate: 17-11-2025, \n" +
                    "reservationStatus: checked in}, issueDate: 03-11-2025, totalAmount: 12500.0}", methodData.toString());
        }
    }
